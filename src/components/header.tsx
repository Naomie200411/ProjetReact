                ...
                <nav>
                    <ul className="flex flex-row gap-4">
                        <li className='relative gap-6 flex flex-col'>
                            <a href="#" className={`font-epilogue text-base font-medium leading-6 text-left ${findJobsClicked ? 'text-[#4640DE]' : 'text-[#515B6F]'} `} onClick={handleFindJobsClick}>Find Jobs</a>
                            {findJobsClicked && <div className="absolute   w-[76px] h-1 mt-14 bg-[#4640DE]"></div>}
                        </li>
                        <li className="relative gap-6 flex flex-col">
                            <a href="#" className={`font-epilogue text-base font-medium leading-6 text-left ${browseCompaniesClicked ? 'text-[#4640DE]' : 'text-[#515B6F]'} `} onClick={handleBrowseCompaniesClick}>Browse Companies</a>
